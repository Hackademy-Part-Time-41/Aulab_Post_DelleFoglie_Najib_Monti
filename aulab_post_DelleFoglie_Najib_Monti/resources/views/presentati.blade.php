<x-layout>
    <div class="container-fluid p-5 text-center">
        <div class="row justify-content-center">
            <div class="col-12">
                <h1 class='display-1'>Presentati</h1>
            </div>
        </div>
    </div>
            ...
            <div class="col-12 col-md-8">
                ...
                <form action="{{route('article.store') }}" method="POST" class="card p-5 shadow" enctype="multipart/form-data">
                    ...
                    <div class="mt-3 text-center">
                        ...
                        <div class="my-3">
                            <label for="subtitle" class="form-label">Cognome</label>
                        ...
                        <div class="mt-3">
                            <label for="body">Raccontaci di te</label>
                    ...
                    <div class="d-flex justify-content-center mt-3">
                        <button class='btn btn-dark' type="submit">Pubblica</button>
